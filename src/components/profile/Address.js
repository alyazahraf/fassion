...
const Address = () => {
    ...
    return (
        <div className='px-8 py-24 lg:top-10 lg:px-36 lg:py-24  bg-light-gray'>
            <div className='px-12 lg:px-24 py-10 gap-5 flex flex-col border rounded-xl border-blue-gray bg-white'>
                ...
                <div className='border-b pb-3 gap-3 flex lg:flex-row flex-col justify-between'>
